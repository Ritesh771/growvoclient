...
-- Add column to project_codes to track if it allows OTP access (if it doesn't exist)
ALTER TABLE public.project_codes 
ADD COLUMN IF NOT EXISTS allows_freelancer_access BOOLEAN DEFAULT true;